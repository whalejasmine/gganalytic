...
class lgbm_tun(model_lgb_m2.lightgbm):
    def __init__(self):
        ...
        super().__init__(name='lgb_m5', clf=LGBMRegressor,comment='lgbm4 feature selection'
...
'visitId', 'visitStartTime', 'vis_date', 'nb_sessions', 'max_visits','index'
    ...
    m.feature_selection_eval(nfolds=5, set=1, file='../output/log/log_fw1.txt', earlystop=False)